...
Решение позволяет производить консолидацию и дедупликацию объектов, что может сократить ресурсы при дальнейшей передаче и обработке, а также увеличить быстродействие.
